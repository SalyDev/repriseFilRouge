...
class GroupeRepository extends ServiceEntityRepository
{
    ...
    */
    ...
    // promo->getTitre().'-Groupe Principal'
     
    public function findPrincipalGroup($promo): ?Groupe
    {
        return $this->createQueryBuilder('g')
            ->where('g.promo = :val1')
            ->andWhere('g.type = :val2')
            ->setParameter('val1', $promo)
            ->setParameter('val2', 'principal')
            // ->setParameter('val2', $promo->getTitre().'-Groupe Principal')
            ->getQuery()
            ->getOneOrNullResult()
        ;
    }
